...
class LoadBEVSegmentation:
    ...
    def __call__(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        file_paths = ['/home/jingxiong/bevfusion-main/V2X-SIM/Town03.h5', '/home/jingxiong/bevfusion-main/V2X-SIM/Town04.h5', '/home/jingxiong/bevfusion-main/V2X-SIM/Town05.h5']
        all_data = load_multiple_h5_files(file_paths)
        all_data['Town03']['Town03/drivable_area'] = np.logical_or(all_data['Town03']['Town03/lane_markings'],np.logical_or(all_data['Town03']['Town03/drivable_area'], all_data['Town03']['Town03/parking_area'])).astype(int)
        all_data['Town04']['Town04/drivable_area'] = np.logical_or(all_data['Town04']['Town04/lane_markings'],np.logical_or(all_data['Town04']['Town04/drivable_area'], all_data['Town04']['Town04/parking_area'])).astype(int)
        all_data['Town05']['Town05/drivable_area'] = np.logical_or(all_data['Town05']['Town05/lane_markings'],np.logical_or(all_data['Town05']['Town05/drivable_area'], all_data['Town05']['Town05/parking_area'])).astype(int)
        town_number = location
        # message = "The map positions are:"
        # print(message, map_pose[0], map_pose[1],town_number)
        x, y, h, w, rot = map_pose[0], map_pose[1], int(self.canvas_size[0]), int(self.canvas_size[1]), patch_angle
        ...
        # print(np.any(data["gt_masks_bev"][5]==1))
        return data
